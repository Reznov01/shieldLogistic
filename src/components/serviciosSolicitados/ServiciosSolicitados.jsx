...
export default function ServiciosSolicitados() {
  return (
    <section className="w-screen min-h-[80vh] h-[1500px] sm:h-[1250px] lg:h-[1400px] xl:h-[800px] flex flex-col items-center relative  mb-40 lg:mb-0">
      ...
      <div className="flex flex-col xl:flex-row gap-10 md:gap-16 absolute top-32  px-6 md:px-auto w-full xl:px-0 xl:top-40">
        <div className="w-full xl:w-1/2 flex justify-center mb-60 sm:mb-30">
          <CardServices
            icon={<MdHomeWork />}
