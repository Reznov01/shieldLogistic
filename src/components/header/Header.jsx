      ...
      <div className="flex flex-col lg:flex-row h-full">
        <div className="lg:w-3/5 bg-gray-100 flex lg:flex-col items-center justify-center mt-10 lg:mt-0 mb-5 sm:mb-0">
          <div className="flex flex-col gap-6 mt-15 lg:mx-auto">
            <motion.h1
              className="xl:text-7xl lg:text-5xl text-4xl ml-5  font-bold "
              initial={{ x: "-100vw" }} // Se inicia completamente fuera del lado derecho
              animate={{ x: 0 }} // Se mueve a su posición normal
              transition={{ duration: 0.2, ease: "easeOut" }}
            >
              Seguridad Privada
            </motion.h1>
            <motion.div
              className="sm:text-3xl text-2xl xl-h-[100%] w-[90%] sm:w-[60%] lg:w-[61%] bg-amber-300 p-2 rounded-2xl mt-4 flex items-center ml-4 2xl:w-[70%]"
              initial={{ x: "-100vw" }}
              animate={{ x: 0 }}
            ...
            <motion.div
              className=" flex gap-5 ml-5 sm:mb-5 lg:ml-5 mb-0 lg:mx-0"
              initial={{ x: "-100vw" }}
              animate={{ x: 0 }}
        ...
        border-blue-200 border-b-[6px] hover:bg-blue-400  hover:-translate-y-[1px] hover:border-b-[6px] hover:border-blue-500
          active:brightness-90 active:translate-y-[2px]"
            ...
            <motion.div
              className="w-fit h-fit flex gap-5 ml-4"
              initial={{ x: "-100vw" }}
              animate={{ x: 0 }}
        ...
        <div className="lg:w-2/5 w-screen h-screen relative flex items-center justify-center bg-gradient-to-tl b-5 from-emerald-100 from- via-red-200 via- to-gray-50 to-https://tailwind-gradient-generator.vercel.app/?gradient=">
          <motion.div
            className="w-[60%] h-[80%] xl:w-[50%] xl:h-[50%] lg:w-[60%] lg:h-[60%] bg-gray-100 relative overflow-hidden"
            initial={{ x: "100vw" }}
            animate={{ x: 0 }}
          ...
          <motion.div
            className="absolute top-5 left-10 sm:left-25 md:left-30 lg:top-40 lg:-left-18 z-10"
            initial={{ x: "100vw" }}
            animate={{ x: 0 }}
            transition={{ duration: 0.4 }}
          >
          ...
          <motion.div
            className="absolute flex flex-col lg:text-xl  text-sm sm:text-sm bottom-0 right-2 2xl:bottom-40 2xl:-left-30 xl:left-20 lg:z-20 bg-yellow-400 p-2 lg:p-8  text-black w-[220px] h-[100px] lg:w-[350px] sm:h-[100px] lg:h-[200px] rounded-md shadow-2xl lg:gap-4 z-20  mb-5 gap-2"
            initial={{ x: "100vw" }}
            animate={{ x: 0 }}
            transition={{ duration: 0.6 }}
          >
